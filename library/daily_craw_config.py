...
class daily_craw_config():
    ...
    def variable_setting(self):
        ...
        self.total_stock_count = len(self.code_df)
        # print("총 종목 수: " + str(self.total_stock_count))

        self.add_value = math.ceil(self.total_stock_count / 10)
        # print("add_value: " + str(self.add_value))

        self.set1 = self.add_value
        self.set2 = self.set1 + self.add_value
        self.set3 = self.set2 + self.add_value
        self.set4 = self.set3 + self.add_value
        self.set5 = self.set4 + self.add_value
        self.set6 = self.set5 + self.add_value
        self.set7 = self.set6 + self.add_value
        self.set8 = self.set7 + self.add_value
        self.set9 = self.set8 + self.add_value
        self.set10 = self.set9 + self.add_value
